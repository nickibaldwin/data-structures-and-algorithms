...
const count = (target, input) => {
    // Solution code here...
    const potato = input.reduce((acc, value) => {
        const taterTot = value.reduce((acc, value) => {
            if (value === target) {
                acc++;
            }
            return acc;
...
const totalSum = (input) => {
        ...
        //     let totalSum = 0;
        //     input.forEach((arrayOfMatrix) => {
        //         arrayOfMatrix.forEach(number => {
        //             totalSum += number;
        //         });
        //     });
        //     return totalSum;
        ...
        let findMaleAndFemale = (data) => {
            // Solution code here...
            return data.filter(characterGender => {
                return characterGender.gender === 'female' || characterGender.gender === 'male';
            }).map(character => {
